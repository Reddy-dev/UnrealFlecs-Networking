...
REGISTER_FLECS_COMPONENT(FFlecsReplicationTestTarget);
REGISTER_FLECS_COMPONENT(FFlecsReplicationTestDontFragmentValueRelationship);
REGISTER_FLECS_COMPONENT(FFlecsReplicationTestDontFragmentValueTarget);
